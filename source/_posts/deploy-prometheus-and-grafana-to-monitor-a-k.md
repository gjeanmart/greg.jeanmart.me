...
This article is part of the series _Build your very own self-hosting platform with Raspberry Pi and Kubernetes_
...
rm -rf manifests
./scripts/build.sh main.jsonnet /home/gr3g/go/bin/jsonnet
using jsonnet from arg
+ set -o pipefail
+ rm -rf manifests
+ mkdir manifests
+ /home/gr3g/go/bin/jsonnet -J vendor -m manifests main.jsonnet
