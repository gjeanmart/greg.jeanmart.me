---
title: (Elastic monitoring - 3/5)  Collect metrics with Elastic Metricbeat for monitoring Kubernetes
...
[Collect logs with Elastic Filebeat for monitoring Kubernetes](/2019/10/19/(45)-collect-logs-with-elastic-filebeat-for-monit)
