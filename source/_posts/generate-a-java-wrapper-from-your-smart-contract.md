...
$ ls -l
total 12
-rw-rw-r-- 1 gr3g gr3g  565 Jun 24 13:42 DocumentRegistry.abi
-rw-rw-r-- 1 gr3g gr3g  676 Jun 24 13:42 DocumentRegistry.bin
-rw-rw-r-- 1 gr3g gr3g 1488 Jun 24 13:40 DocumentRegistry.sol
```
...
```shell
$ web3j solidity generate -a DocumentRegistry.abi  -b DocumentRegistry.bin -o . -p me.gr3g.tutorials.javaethereum.wrapper
...
Generating me.gr3g.tutorials.javaethereum.wrapper.DocumentRegistry ... File written to .
```
...
```shell
./me/gr3g/tutorials/javaethereum/wrapper/DocumentRegistry.java
```
...
$ ls -l
total 20
drwxrwxr-x 2 gr3g gr3g 4096 Jun 24 14:25 contracts
drwxrwxr-x 2 gr3g gr3g 4096 Jun 24 14:25 migrations
drwxrwxr-x 2 gr3g gr3g 4096 Jun 24 14:25 test
-rw-rw-r-- 1 gr3g gr3g 4233 Jun 24 14:25 truffle-config.js
```
...
> Artifacts written to /home/gr3g/workspace/tutorials/java-ethereum-wrapper/truffle/build/contracts
> Compiled successfully using:
   - solc: 0.5.8+commit.23d335f2.Emscripten.clang

$ ls -l build/contracts/
total 136
-rw-rw-r-- 1 gr3g gr3g 79721 Jun 24 14:33 DocumentRegistry.json
-rw-rw-r-- 1 gr3g gr3g 54043 Jun 24 14:33 Migrations.json
```
...
```shell
$ web3j  truffle generate ./build/contracts/DocumentRegistry.json -o . -p me.gr3g.tutorials.javaethereum.wrapper
        ...
        <plugin>
            ...
            <executions>
                <execution>
                    ...
                    <configuration>
                        <packageName>me.gr3g.tutorials.javaethereum.contracts.generated</packageName>
...
```groovy
web3j {
    generatedPackageName = 'me.gr3g.tutorials.javaethereum.contracts.generated'
